...
public class WordPairCount  extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new WordPairCount(), args);
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context
        	...
        	String delim = "[^a-z A-Z 0-9]+";
        	String validValue = value.toString().replaceAll(delim, " ");
        	String word1 = null, word2 = null;
            StringTokenizer itr = new StringTokenizer(validValue, " ");
            ...
            while (itr.hasMoreTokens()) {
				...
				if(!word1.isEmpty() && !word2.isEmpty()) {
					Text outKey = new Text(word1+ " " + word2);
